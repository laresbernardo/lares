...
#'
#' To start using lares you can start by the vignette:
#' `browseVignettes(package = "lares")`
#' 
...
#' @importFrom lubridate date day week weeks month year wday dmy_hms dmy ymd_hms ymd setdiff minute hour
