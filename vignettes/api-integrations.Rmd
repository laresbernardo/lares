...
# LARES_GEMINI_MODEL=gemini-3.5-flash-lite

# Check current settings
Sys.getenv(c("LARES_GPT_MODEL", "LARES_GEMINI_API", "LARES_GEMINI_MODEL"))
```
...
- **All lares articles:** [Author page on R-bloggers](https://www.r-bloggers.com/author/bernardo-lares/)
