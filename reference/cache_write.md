...
cache_write(x, base)
#> > Cache saved succesfully: lares_cache_2026-07-01.A.B
cache_read(base, ask = FALSE)
#> > Cache loaded succesfully: lares_cache_2026-07-01.A.B
#> $a
#> [1] 1
#> 
#> $b
...
#> [1] TRUE
#> attr(,"filename")
#> [1] "/tmp/RtmpNcIuBI/lares_cache_2026-07-01.A.B.RDS"
#> attr(,"base")
#> [1] "lares_cache_2026-07-01.A.B"
#> attr(,"cache_dir")
#> [1] "/tmp/RtmpNcIuBI"
cache_clear()
